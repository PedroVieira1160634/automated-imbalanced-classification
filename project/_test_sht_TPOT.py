...
cv = RepeatedStratifiedKFold(n_splits=2, n_repeats=2, random_state=42)        #10, 3
...
#scoring='f1', cv=cv
tpot = TPOTClassifier(generations=2, population_size=2, max_time_mins=10, n_jobs=-1, random_state=42, verbosity=2)
