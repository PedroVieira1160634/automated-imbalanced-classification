...
list_openml = [1037, 966, 1023, 968, 42883, 833, 761, 735, 1489, 1524, 1511, 312, 1004, 934, 1025, 728, 41156, 796, 994, 733, 337, 40701, 978, 
               971, 947, 40983, 1016, 962, 1049, 954, 976, 1022, 764, 1020, 41946, 450, 1116, 40713]
for id in list_openml:
    execute_ml("", id)
    print("\n----------------------------------\n")
#OPENML
